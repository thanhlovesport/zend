...
class Cat{
	...
	*/
	// Cat đóng vai trò của hàm construct
	/* public function Cat($name = 'Doremon', $age = 10, $color = 'blue'){
	    $this->name		= $name;
	    $this->color	= $color;
	    $this->age		= $age;
	} */
	public function __construct($name = 'Doremon', $age = 10, $color = 'blue',$weight = '1kg'){
	    $this->name		= $name;
	    $this->color	= $color;
	    $this->age		= $age;
	    $this->weight   = $weight;
